...
void TaskShow(void *data)
{
  ...
  for (;;)
  {
    ...
    if (!edit)
    {
      ...
      data_1[4] = now_set / 10000 % 10;
      data_1[5] = now_set / 100000 % 10;
      data_1[6] = now_set / 1000000 % 10;
      data_1[7] = now_set / 10000000 % 10;
      data_1[8] = now_set / 100000000 % 10;
      data_1[9] = now_set / 1000000000;
