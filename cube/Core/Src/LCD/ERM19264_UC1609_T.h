...
#define CD LL_GPIO_PIN_1
#define RST LL_GPIO_PIN_0
#define CS LL_GPIO_PIN_4

#define UC1609_CD_SetHigh HAL_GPIO_WritePin(GPIOA, CD, GPIO_PIN_SET);
#define UC1609_CS_SetHigh HAL_GPIO_WritePin(GPIOA, CS, GPIO_PIN_SET);
#define UC1609_RST_SetHigh HAL_GPIO_WritePin(GPIOA, RST, GPIO_PIN_SET);
#define UC1609_CD_SetLow HAL_GPIO_WritePin(GPIOA, CD, GPIO_PIN_RESET);
#define UC1609_CS_SetLow HAL_GPIO_WritePin(GPIOA, CS, GPIO_PIN_RESET);
#define UC1609_RST_SetLow HAL_GPIO_WritePin(GPIOA, RST, GPIO_PIN_RESET);
